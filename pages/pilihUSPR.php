...
<html>
    ...
    <body>
        ...
        <header class="header-container">
            ...
            <h1 id="headText">Pemilihan Umum Ketua USPR</h1>
        </header>
        ...
        <?php 
            include '../koneksi.php';
            $nim=$_GET['nim'];
            $res=mysqli_query($link,"select nama from kpubinus2019.msuspr where nim=$nim");
        ...
        <div class="card-container-pilih">
                <div class="cards">
                <a href="../pages/saveUSPR.php?id=1&nim=<?php echo $nim?>" class="linkCard">
                    <h3 style="font-family: Arial, Helvetica, sans-serif">CALON 1</h3>
                    <img src="../assets/calon/USPR1.jpg" alt="calonUrut1" class="fotoCalon">
                    <div class="container">
                        <p>Agatha Febriola</p>
                    </div>
                </a>     
            ...
            <div class="cards">
                <a href="../pages/saveUSPR.php?id=2&nim=<?php echo $nim?>" class="linkCard">
                    <h3 style="font-family: Arial, Helvetica, sans-serif">CALON 2</h3>
                    <img src="../assets/calon/USPR2.jpg" alt="calonUrut2" class="fotoCalon">
                    <div class="container">
                        <p>Nadya Ovelia</p>
                    </div>
                </a>
