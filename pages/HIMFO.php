...
<html>
    ...
    <body>
        ...
        <header class="header-container">
            ...
            <h1 id="headText">Pemilihan Umum Ketua HIMFO</h1>
        </header>

        <!-- LOGIN BOX -->
        <div class="card-container-login">
                <div class="cards">
                    <img src="../assets/logo-jurusan/HIMFO.png" alt="logoHIMFO" id="imgLogo">
                    <legend style="font-family : Arial, Helvetica, sans-serif; margin-top:20px;">
                            <?php 
                                if(isset($_GET['login'])){
                                    ...
                                    if($_GET['login']=="pilih") echo "<h4 style='color:green'>Anda sudah memilih!</h4><br/>";
                                }
                            ?>
                        </legend>
                    <form action="loginHIMFO.php" method="post" autocomplete="off">
                        <div id="user-input">
