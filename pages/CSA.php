...
<html>
    ...
    <body>
        ...
        <header class="header-container">
            ...
            <h1 id="headText">Pemilihan Umum Ketua CSA</h1>
        </header>
        ...
        <div class="card-container-login">
                ...
                <div class="cards">
                    <img src="../assets/logo-jurusan/CSA.png" alt="logoCSA" id="imgLogo">
                    ...
                    <form action="loginCSA.php" method="post" autocomplete="off">
                        <div id="user-input">
